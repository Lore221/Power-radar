...
public final class PowerRadarClientConfig {
        ...
        private static final ModConfigSpec.ConfigValue<String> UNKNOWN_BLIP_COLOR;
        private static final ModConfigSpec.ConfigValue<String> RADAR_BLIP_COLOR;
        ...
        private static String cachedUnknownColor;
        private static String cachedRadarColor;
        ...
        static {
                ...
                RADAR_CONE_COLOR = defineColor(builder, "cone_color", "#00ff00",
                                "Color applied to the white radar coverage cone texture.");
                SHELL_ALARM_ZONE_COLOR = defineColor(builder, "shell_alarm_zone_color", "#3399ff",
                ...
                PLAYER_BLIP_COLOR = defineColor(builder, "player_color", "#0000ff",
                ...
                HOSTILE_BLIP_COLOR = defineColor(builder, "hostile_mob_color", "#FF0000",
                                "Color of hostile mob blips.");
                UNKNOWN_BLIP_COLOR = defineColor(builder, "unknown_color", "#ffff00",
                                "Color of unknown blips, including invisible players and mobs.");
                RADAR_BLIP_COLOR = defineColor(builder, "radar_color", "#ffffff",
                                "Color of detected radar emitter blips.");
        ...
        public static RadarRenderPalette radarRenderPalette() {
                // Снимок палитры пересобирается только после изменения строк конфига и
                // переиспользуется за кадр.
                ...
                String unknown = colorValue(UNKNOWN_BLIP_COLOR);
                String radar = colorValue(RADAR_BLIP_COLOR);
                ...
                if (palette == null
                                ...
                                || !unknown.equals(cachedUnknownColor)
                                || !radar.equals(cachedRadarColor)
                        ...
                        cachedUnknownColor = unknown;
                        cachedRadarColor = radar;
        ...
        public record RadarRenderPalette(
                ...
                public int blip(RadarTargetCategory category) {
                        return switch (category) {
                                ...
                                case SABLE_STRUCTURE -> this.sableSilhouette;
